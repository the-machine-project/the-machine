...
namespace machine
{
    ...
    {
        FaceAdmin, FaceAuxAdmin, FaceAsset, FaceSecondary, FaceNone
    }
    ...
    public partial class MainWindow : Window
    {
        ...
        /***
            ...
            Parameter(s): bool train
                ...
                normal execution).
                          String nt
                The name of the person tht the Machine is training itself to recognize (supposed to be equal to "" during normal execution).
                          int cn
        ...
        ***/
        public MainWindow(bool train, FaceIdentity fit, String nt, int cn, int fps, bool crd, int mdt,
            MachineInputSourceKind misk, String t)
        {
            ...
            secondary_focus = new Bitmap("assets\\secondary_focus.jpg");
        ...
        ***/
        private void MachineExecution()
        {
            if (machineInputSourceKind == MachineInputSourceKind.SourceNone)
                Close(); // Gracefully exit if no input source was selected.
